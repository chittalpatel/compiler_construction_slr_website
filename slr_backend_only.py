...
def main(productions: List[str]):
	...
	for nt in ntl:
		...
		first = firstfollow.get_first(nt)
		follow = firstfollow.get_follow(nt)
		ff[nt] = {
			"first": first,
			"follow": follow,
		}
